...
const Incrementer = ({ currentValue, updateFn, itemName }) => {
    ...
    return (
        <div className={styles.incrementer}>
            ...
            <input className={styles.incrementerField} type="text" inputMode="numeric" pattern="^$|^[1-9]\d*$" value={currentValue} onChange={(e) => handleChange(e.target.value)} onKeyDown={handleKeyDown} aria-label={itemName ? `${itemName} Quantity` : "Quantity"} />
